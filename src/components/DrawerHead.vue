<template>
  <div class="flex items-center gap-5 mb-5">
    <svg class="rotate-180 cursor-pointer opacity-50 hover:opacity-100 transition-opacity" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
